...
public class UserShopController {
    ...
    @SwaggerApiSuccess(summary = "전체 사용자의 주문내역 목록 조회", implementation = Page.class)
    @SwaggerApiError
    @GetMapping("/api/shop-orders")
    public Page<OrderListDto> findOrders(final Pageable pageable) {
        return userShopService.findByCreatedDateDescUsingPaging(pageable).map(OrderListDto::new);
    }
